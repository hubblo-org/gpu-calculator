  ...
  <form>
    ...
    <div class="grid">
      <div class="field">
        ...
        <input type="number" id="casing-weight" bind:value={card.parameters!.casingWeight} />
        <label for="heatsink-weight">Heatsink weight (grams)</label>
        <input type="number" id="heatsink-weight" bind:value={card.parameters!.heatsinkWeight} />
        <label for="graphics-card-surface">Graphics card surface (cm²)</label>
        <input type="number" id="graphics-card-surface" bind:value={card.parameters!.cardSurface} />
        <label for="gpu-surface">GPU surface (mm²)</label>
        <input type="number" id="gpu-surface" bind:value={card.parameters!.gpuSurface} />
      </div>
      <div class="field">
        <label for="vram-size">Video RAM capacity (GB)</label>
        <input type="number" id="vram-size" bind:value={card.parameters!.videoRamCapacity} />
        <label for="vram-dies">Video RAM dies</label>
        <input type="number" id="vram-dies" bind:value={card.parameters!.videoRamDies} />
